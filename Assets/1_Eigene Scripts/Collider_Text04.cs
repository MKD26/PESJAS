...
public class Collider_Text04 : MonoBehaviour
{
    ...
    private string dialogzeilenText = "´Hinter mir befindet sich Campus 1. Im ersten Stock befindet sich der große Serverraum... Dieser lässt sich nicht mal mehr öffnen.`";
